...
class EditCategoryPageState extends State<EditCategoryPage> {
  ...
  Future<void> _updateCategory() async {
    ...
    print('🔄 Iniciando actualización de categoría...');

    final categoryId = widget.category['_id'].toString();
  ...
  Future<void> _deleteCategory() async {
    ...
    if (confirm == true) {
      print('🗑️ Iniciando eliminación de categoría...');
      
      final categoryId = widget.category['_id'].toString();
      final success = await categoryController.deleteCategory(categoryId);
